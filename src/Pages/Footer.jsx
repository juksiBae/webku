					...
					<div class="grid grid-cols-2 sm:grid-cols-3">
						<div className=" ">
							...
							<ul class="text-gray-400 dark:text-gray-400 font-medium">
								...
								<li>
									<a href="https://www.instagram.com/fajar_batagor/" class="hover:underline">
										BINTANG
									</a>
								</li>
							</ul>
						...
						<div className="">
							...
							<ul class="text-gray-400 dark:text-gray-400 font-medium">
								<li class="mb-2">
									<a href="https://www.instagram.com/team.rotasi_a1" class="hover:underline ">
										Instagram
									</a>
								</li>
								<li>
				...
				<div class="sm:flex sm:items-center sm:justify-between">
					<div class="flex mt-4 justify-center sm:mt-0">
						<p className="text-[0.7rem] text-white opacity-70">
							© {new Date().getFullYear()} Kelas XII TJKT 1 | Di Kelola Oleh Siswa TJKT 1
						</p>
					</div>
				</div>
			</div>
